...
1. **IEEE Software Journal (2025).** *The Shift to Systems Thinking: Requirements Engineering in the Era of Generative AI.* Vol. 42, No. 2, pp. 34-41. Focuses on the elevated value of human translation skills when handling ambiguous client needs.
2. **ACM Digital Library (2025).** *Empirical Limitations of Large Language Models in Complex Software Architecture.* Investigation into why AI assistants fail at global optimization across large-scale legacy codebases.
